                ...
                <div class="col-lg-6 col-md-6">
                    <div class="widgets_container contact_us">
                        ...
                        <div class="footer_contact">
                            <p>Address: 600, đường Nguyễn Văn Cừ (nối dài), phường An Bình, quận Ninh Kiều, TP. Cần Thơ</p>
                            <p>Phone: <a href="tel:+(+84)912475351">(+84)912475351</a> </p>
                            <p>Email: <a href="mailto:phuvdhce160500@fpt.edu.vn">phuvdhce160500@fpt.edu.vn</a></p>
                            <ul>
                                <li><a href="#" title="google-plus"><i class="fa fa-google-plus"></i></a></li>
                                <li><a href="https://www.facebook.com/vo.phu.7906/" title="facebook"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="https://www.youtube.com/c/J97imjack" title="youtube"><i class="fa fa-youtube"></i></a></li>
                            </ul>
