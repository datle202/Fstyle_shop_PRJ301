...
public class User extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("checkLogin")) {
            ...
            com.Models.User user = dao.checkUser(user_email, user_pass);
            if (user == null) {
        ...
        if (action.equals("myaccount")) {
            try {
                HttpSession session = request.getSession();
                com.Models.User user = (com.Models.User) session.getAttribute("user");
                if (user != null) {
                    int user_id = user.getUser_id();
                    billDAO dao = new billDAO();
                    List<com.Models.Bill> bill = dao.getBillByID(user_id);
        ...
        if (action.equals("updateinfo")) {
            try {
                ...
                if (user != null) {
                    ...
                    com.Models.User user1 = new com.Models.User(user.getUser_id(), user_name, user.getUser_email(), user_pass, user.getIsAdmin());
        ...
        if (action.equals("signup")) {
            ...
            if (!user_pass.equals(re_pass)) {
                ...
                userDAO dao = new userDAO();
                com.Models.User a = dao.checkAcc(user_email);
                if (a == null) {
